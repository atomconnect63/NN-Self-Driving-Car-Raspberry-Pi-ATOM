...
print ('Total Training Images: ', len(yVal))
print ('Total Validation Images: ', len(yTrain))
...
history = model.fit(dataGen(xVal, yVal, 100, 1),
                    steps_per_epoch=100, epochs=10,
                    validation_data=dataGen(xTrain, yTrain, 50, 0),
                    validation_steps=50)
